...
import time
import usrp_threshold_gpio_3_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class usrp_threshold_gpio_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_threshold_gpio_3")
...
def main(top_block_cls=usrp_threshold_gpio_3, options=None):
