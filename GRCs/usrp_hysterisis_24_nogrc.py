...
import time
import sip
import usrp_hysterisis_24_epy_block_0_1 as epy_block_0_1  # embedded python block
...
class usrp_hysterisis_24(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        '''---------------Important Line: We pass the global variable that determines which AP we are connected to using the 'connected_to' gobal variable------------------'''
        
        self.epy_block_0_1 = epy_block_0_1.blk(example_param=connected_to)
