...
class usrp_slow_sample_rate_25(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_slow_sample_rate_25")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/aerolifi/Documents/GRCs/file2.txt', True, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.digital_ofdm_tx_0, 0))
...
def main(top_block_cls=usrp_slow_sample_rate_25, options=None):
