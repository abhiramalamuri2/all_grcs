...
class limebc_limeb7_ofdm_13(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limebc_limeb7_ofdm_13")
...
def main(top_block_cls=limebc_limeb7_ofdm_13, options=None):
