...
class usrp_limesdr_ofdm_12(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_limesdr_ofdm_12")
        ...
        self.connect((self.limesdr_source_0, 0), (self.digital_ofdm_rx_0, 0))
...
def main(top_block_cls=usrp_limesdr_ofdm_12, options=None):
