...
class limesdr_limesdr_const_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limesdr_limesdr_const_2")
...
def main(top_block_cls=limesdr_limesdr_const_2, options=None):
    if options is None:
