...
class usrp_2_channel_test_16(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_2_channel_test_16")
        ...
        self.uhd_usrp_sink_0_0.set_center_freq(20e06, 0)
        self.uhd_usrp_sink_0_0.set_antenna('A', 0)
        self.uhd_usrp_sink_0_0.set_bandwidth(5e6, 0)
        self.uhd_usrp_sink_0_0.set_gain(40, 0)

        self.uhd_usrp_sink_0_0.set_center_freq(40e06, 1)
        self.uhd_usrp_sink_0_0.set_antenna('A', 1)
        self.uhd_usrp_sink_0_0.set_bandwidth(5e6, 1)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/dev/pts/2', False)
        ...
        self.connect((self.digital_psk_mod_0, 0), (self.uhd_usrp_sink_0_0, 0))
        self.connect((self.digital_psk_mod_0, 0), (self.uhd_usrp_sink_0_0, 1))
...
def main(top_block_cls=usrp_2_channel_test_16, options=None):
