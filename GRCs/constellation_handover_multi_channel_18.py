...
import time
import constellation_handover_multi_channel_18_epy_block_0_1 as epy_block_0_1  # embedded python block
import constellation_handover_multi_channel_18_epy_block_0_1_0 as epy_block_0_1_0  # embedded python block
import sip



class constellation_handover_multi_channel_18(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "constellation_handover_multi_channel_18")
        ...
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_char*1, '/dev/pts/1', False)
        self.blocks_file_sink_0_0_1.set_unbuffered(False)
        self.blocks_file_sink_0_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/dev/pts/2', False)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0_0, 0), (self.digital_ofdm_tx_0_1, 0))
        self.connect((self.digital_ofdm_rx_0, 0), (self.epy_block_0_1, 2))
        self.connect((self.digital_ofdm_rx_0_1, 0), (self.epy_block_0_1_0, 2))
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.digital_ofdm_tx_0_1, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.epy_block_0_1, 0), (self.blocks_file_sink_0_0_1, 0))
        self.connect((self.epy_block_0_1_0, 0), (self.blocks_file_sink_0_0_0_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.digital_ofdm_rx_0, 0))
        self.connect((self.uhd_usrp_source_0, 1), (self.digital_ofdm_rx_0_1, 0))
...
def main(top_block_cls=constellation_handover_multi_channel_18, options=None):
