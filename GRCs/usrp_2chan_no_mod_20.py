...
import time
import sip
import usrp_2chan_no_mod_20_epy_block_0 as epy_block_0  # embedded python block
import usrp_2chan_no_mod_20_epy_block_0_0 as epy_block_0_0  # embedded python block



class usrp_2chan_no_mod_20(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_2chan_no_mod_20")
        ...
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_cma( variable_constellation_1, .0005, 4).base()
        self.sps = sps = 4
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, 0.0628, firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts), nfilts, (nfilts/2), 1.5, 1)
        ...
        self.digital_linear_equalizer_0_0 = digital.linear_equalizer(8, 1, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        self.digital_linear_equalizer_0 = digital.linear_equalizer(8, 1, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        self.digital_costas_loop_cc_2_0_0 = digital.costas_loop_cc(0.0628, 4, True)
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/dev/pts/3', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0_0_0, 0), (self.blocks_file_sink_0_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0, 0), (self.digital_correlate_access_code_xx_ts_1_0, 0))
        self.connect((self.digital_constellation_decoder_cb_1_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0, 0))
        self.connect((self.digital_constellation_decoder_cb_1_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0, 0))
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.digital_constellation_modulator_0_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.digital_correlate_access_code_xx_ts_1, 0), (self.blocks_repack_bits_bb_0_0_0, 0))
        self.connect((self.digital_correlate_access_code_xx_ts_1_0, 0), (self.blocks_repack_bits_bb_0_0_0_0, 0))
        self.connect((self.digital_costas_loop_cc_2_0, 0), (self.digital_linear_equalizer_0, 0))
        self.connect((self.digital_costas_loop_cc_2_0_0, 0), (self.digital_linear_equalizer_0_0, 0))
        ...
        self.connect((self.digital_linear_equalizer_0_0, 0), (self.digital_constellation_decoder_cb_1_0_0, 0))
        self.connect((self.digital_linear_equalizer_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 1), (self.digital_pfb_clock_sync_xxx_0_0, 0))
...
def main(top_block_cls=usrp_2chan_no_mod_20, options=None):
    if options is None:
