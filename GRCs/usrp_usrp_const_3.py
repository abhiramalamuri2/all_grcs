...
import time
import usrp_usrp_const_3_epy_block_0_1 as epy_block_0_1  # embedded python block



from gnuradio import qtgui

class usrp_usrp_const_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_usrp_const_3")
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.250)
...
def main(top_block_cls=usrp_usrp_const_3, options=None):
    if options is None:
