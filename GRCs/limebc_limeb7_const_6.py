...
class limebc_limeb7_const_6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limebc_limeb7_const_6")
...
def main(top_block_cls=limebc_limeb7_const_6, options=None):
    if options is None:
