...
import time
import handover_print_txID_21_epy_block_0 as epy_block_0  # embedded python block
import handover_print_txID_21_epy_block_0_0 as epy_block_0_0  # embedded python block
import handover_print_txID_21_epy_block_0_1 as epy_block_0_1  # embedded python block



from gnuradio import qtgui

class handover_print_txID_21(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "handover_print_txID_21")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/aerolifi/Documents/GRCs for Calculations/input.txt', True, 0, 0)
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.blocks_file_sink_0_0, 0))
        self.connect((self.digital_ofdm_rx_0_0, 0), (self.blocks_file_sink_0_0_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.digital_ofdm_tx_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.digital_ofdm_tx_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        ...
        self.connect((self.epy_block_0_1, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.digital_ofdm_rx_0, 0))
        self.connect((self.uhd_usrp_source_0, 1), (self.digital_ofdm_rx_0_0, 0))
...
def main(top_block_cls=handover_print_txID_21, options=None):
