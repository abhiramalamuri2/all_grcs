...
class limesdr_usrp_ofdm_11(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limesdr_usrp_ofdm_11")
        ...
        self.uhd_usrp_source_0.set_center_freq(30e06, 0)
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_ofdm_rx_0, 0))
...
def main(top_block_cls=limesdr_usrp_ofdm_11, options=None):
