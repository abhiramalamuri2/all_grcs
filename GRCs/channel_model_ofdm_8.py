...
class channel_model_ofdm_8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "channel_model_ofdm_8")
        ...
        self._gain_range = Range(0, 32, 0.5, 10, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aerolifi/Documents/GRCs/out.txt', False)
...
def main(top_block_cls=channel_model_ofdm_8, options=None):
