...
class limesdr_usrp_const_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limesdr_usrp_const_4")
...
def main(top_block_cls=limesdr_usrp_const_4, options=None):
    if options is None:
