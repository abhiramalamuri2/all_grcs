...
class limeb7_limebc_const_7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limeb7_limebc_const_7")
        ...
        self.limesdr_source_0 = limesdr.source('1D3AD634EA32BC', 0, '', False)
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aerolifi/Documents/GRCs/out.txt', False)
...
def main(top_block_cls=limeb7_limebc_const_7, options=None):
    if options is None:
