...
import time
import usrp_usrp_ofdm_epy_block_0_1_0 as epy_block_0_1_0  # embedded python block
import usrp_usrp_ofdm_epy_block_0_1_0_1 as epy_block_0_1_0_1  # embedded python block



from gnuradio import qtgui

class usrp_usrp_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_usrp_ofdm")
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.epy_block_0_1_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.epy_block_0_1_0, 0), (self.blocks_null_sink_1_0, 0))
...
def main(top_block_cls=usrp_usrp_ofdm, options=None):
