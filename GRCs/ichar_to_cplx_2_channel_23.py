...
import time
import ichar_to_cplx_2_channel_23_epy_block_0 as epy_block_0  # embedded python block
import ichar_to_cplx_2_channel_23_epy_block_0_1 as epy_block_0_1  # embedded python block
import sip



class ichar_to_cplx_2_channel_23(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ichar_to_cplx_2_channel_23")
        ...
        self.connect((self.digital_ofdm_rx_0_0, 0), (self.epy_block_0_1, 1))
...
def main(top_block_cls=ichar_to_cplx_2_channel_23, options=None):
