...
class limesdr_limesdr_ofdm_9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limesdr_limesdr_ofdm_9")
        ...
        self.limesdr_source_0_0 = limesdr.source('1D3AC688509AB7', 0, '', False)
        ...
        self.limesdr_sink_0 = limesdr.sink('1D3AC688509AB7', 0, '', '')
...
def main(top_block_cls=limesdr_limesdr_ofdm_9, options=None):
