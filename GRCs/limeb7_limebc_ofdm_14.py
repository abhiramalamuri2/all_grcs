...
class limeb7_limebc_ofdm_14(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "limeb7_limebc_ofdm_14")
        ...
        self.limesdr_source_0_0 = limesdr.source('1D3AD634EA32BC', 0, '', False)


        self.limesdr_source_0_0.set_sample_rate(samp_rate)


        self.limesdr_source_0_0.set_center_freq(30e6, 0)
        ...
        self.limesdr_source_0_0.set_gain(50, 0)
        ...
        self.limesdr_sink_0 = limesdr.sink('1D3AD634EA32BC', 0, '', '')
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aerolifi/Documents/OFDM/out.txt', False)
        ...
        self.connect((self.limesdr_source_0_0, 0), (self.digital_ofdm_rx_0, 0))
        self.connect((self.limesdr_source_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=limeb7_limebc_ofdm_14, options=None):
