...
import time
import sip
import usrp_handover_19_epy_block_0 as epy_block_0  # embedded python block
import usrp_handover_19_epy_block_0_0 as epy_block_0_0  # embedded python block
import usrp_handover_19_epy_block_0_1 as epy_block_0_1  # embedded python block
import usrp_handover_19_epy_block_1 as epy_block_1  # embedded python block



class usrp_handover_19(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_handover_19")
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.epy_block_0_1, 0))
        self.connect((self.digital_ofdm_rx_0_1, 0), (self.epy_block_0_1, 1))
        ...
        self.connect((self.epy_block_1, 0), (self.epy_block_0_1, 2))
...
def main(top_block_cls=usrp_handover_19, options=None):
