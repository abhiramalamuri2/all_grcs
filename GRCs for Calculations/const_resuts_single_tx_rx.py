...
import time
import const_resuts_single_tx_rx_epy_block_0_1 as epy_block_0_1  # embedded python block
import sip



class const_resuts_single_tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "const_resuts_single_tx_rx")
        ...
        self.M = M = 2
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_cma( variable_constellation_1, .0005, M).base()
        self.sps = sps = 2
        ...
        self.digital_costas_loop_cc_2_0 = digital.costas_loop_cc(0.0628, M, True)
        ...
        self.blocks_unpack_k_bits_bb_0_0_0 = blocks.unpack_k_bits_bb(N)
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aerolifi/Documents/GRCs for Calculations/output.txt', False)
        ...
        self.connect((self.epy_block_0_1, 0), (self.blocks_null_sink_1, 0))
...
def main(top_block_cls=const_resuts_single_tx_rx, options=None):
    if options is None:
