...
import ber_ofdm_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class ber_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ber_ofdm")
        ...
        self._noise_range = Range(0, 0.1, 0.001, 0, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.015)
...
def main(top_block_cls=ber_ofdm, options=None):
