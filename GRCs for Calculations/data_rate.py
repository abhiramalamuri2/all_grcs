...
class data_rate(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "data_rate")
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_probe_rate_0, 0))
...
def main(top_block_cls=data_rate, options=None):
